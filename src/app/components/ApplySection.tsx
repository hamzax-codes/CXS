...
export default function ApplySection() {
  ...
  return (
    <section id="apply" className="reveal-section py-24 bg-gradient-to-br from-slate-50 via-teal-50 to-emerald-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div ref={ref} className="text-center mb-14">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-teal-100 text-teal-700 px-4 py-2 rounded-full border border-teal-200 mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          >
            <div className="bg-gradient-to-br from-teal-600 to-teal-800 rounded-3xl p-7 text-white shadow-xl shadow-teal-500/20">
              <Mountain className="w-10 h-10 mb-4 text-teal-200" />
              ...
              {[
                ...
                >
                  ...
                  <span className="text-teal-100 text-sm">{benefit}</span>
                </motion.div>
              ))}
            </div>
          ...
          >
            {submitted ? (
              <motion.div
                ...
                className="glass-white rounded-4xl p-12 shadow-2xl text-center h-full flex flex-col items-center justify-center border border-teal-500/20"
                style={{ borderRadius: '2rem' }}
              >
                <div className="w-24 h-24 rounded-[2rem] bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-teal-500/40 rotate-12">
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="relative group">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-11 pr-4 py-3.5 bg-white/50 border border-slate-200/60 rounded-2xl text-slate-800 text-sm placeholder:text-slate-400 focus:outline-none focus:border-teal-400 focus:bg-white focus:ring-4 focus:ring-teal-500/10 transition-all font-medium"
                    />
                  </div>
                  <div className="relative group">
                ...
                {/* Phone */}
                <div className="relative group">
                  <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-teal-500 transition-colors" />
                  <input
                    type="tel"
                    name="phone"
                    value={form.phone}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="relative group">
                    <BookOpen className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 pointer-events-none group-focus-within:text-teal-500 transition-colors" />
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full pl-11 pr-10 py-3.5 bg-white/50 border border-slate-200/60 rounded-2xl text-slate-800 text-sm focus:outline-none focus:border-teal-400 focus:bg-white focus:ring-4 focus:ring-teal-500/10 transition-all appearance-none font-medium cursor-pointer"
                    >
                  ...
                  <div className="relative group">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-5 pr-10 py-3.5 bg-white/50 border border-slate-200/60 rounded-2xl text-slate-800 text-sm focus:outline-none focus:border-teal-400 focus:bg-white focus:ring-4 focus:ring-teal-500/10 transition-all appearance-none font-medium cursor-pointer"
                    >
                    ...
                    {skills.map(({ value, label }) => (
                      <button
                        ...
                        className={`px-3.5 py-2 rounded-xl text-xs font-semibold transition-all duration-300 border ${selectedSkills.includes(value)
                            ? 'bg-gradient-to-tr from-teal-500 to-teal-400 text-white border-transparent shadow-md shadow-teal-500/30 -translate-y-0.5'
                            : 'bg-white/60 text-slate-600 border-slate-200/60 hover:border-teal-300 hover:bg-teal-50 hover:text-teal-600 hover:-translate-y-0.5'
                          }`}
                      >
                        {label}
                      </button>
                ...
                <div className="relative group">
                  <textarea
                    ...
                    required
                    className="w-full px-5 py-4 bg-white/50 border border-slate-200/60 rounded-2xl text-slate-800 text-sm placeholder:text-slate-400 focus:outline-none focus:border-teal-400 focus:bg-white focus:ring-4 focus:ring-teal-500/10 transition-all resize-none font-medium"
                  />
                </div>
